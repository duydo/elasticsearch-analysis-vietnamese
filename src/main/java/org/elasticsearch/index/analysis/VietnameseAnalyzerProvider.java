...
public class VietnameseAnalyzerProvider extends AbstractIndexAnalyzerProvider<VietnameseAnalyzer> {
    ...
    @Inject
    public VietnameseAnalyzerProvider(Index index, IndexSettingsService indexSettingsService, Environment env,
                                      @Assisted String name,
                                      @Assisted Settings settings) {
        super(index, indexSettingsService.getSettings(), name, settings);
        analyzer = new VietnameseAnalyzer(
                Analysis.parseStopWords(env, settings, VietnameseAnalyzer.getDefaultStopSet(), true)
        );
    }
